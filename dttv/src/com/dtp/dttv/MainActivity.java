...
public class MainActivity extends Activity {
    ...
    public void ChooseFile(View view) {
    	...
    	Intent fileExploreIntent = new Intent(
				com.dtp.dttv.FileBrowserActivity.INTENT_ACTION_SELECT_FILE,
				null,
				this,
				com.dtp.dttv.FileBrowserActivity.class
				);
		fileExploreIntent.putExtra(com.dtp.dttv.FileBrowserActivity.startDirectoryParameter, Environment.getExternalStorageDirectory());
